...
faros_polito_IMG_sender_actua: faros_polito_IMG_sender.c errlib.c sockwrap.c faros_polito_IMG_rtp.c faros_polito_IMG_jpg.c faros_polito_IMG_common.c 
	$(CC) $(CFLAGS) $(LDFLAGS) -DACTUA -ljpeg -o faros_polito_IMG_sender_actua faros_polito_IMG_sender.c errlib.c sockwrap.c faros_polito_IMG_rtp.c faros_polito_IMG_jpg.c faros_polito_IMG_common.c 
...
faros_polito_IMG_sender: faros_polito_IMG_sender.c errlib.c sockwrap.c faros_polito_IMG_rtp.c faros_polito_IMG_jpg.c faros_polito_IMG_common.c faros_polito_IMG_input_v4l.c
	$(CC) $(CFLAGS) $(LDFLAGS) -ljpeg -o faros_polito_IMG_sender faros_polito_IMG_sender.c errlib.c sockwrap.c faros_polito_IMG_rtp.c faros_polito_IMG_jpg.c faros_polito_IMG_common.c faros_polito_IMG_input_v4l.c
...
faros_polito_IMG_receiver: faros_polito_IMG_receiver.c errlib.c sockwrap.c faros_polito_IMG_rtp.c faros_polito_IMG_jpg.c faros_polito_IMG_common.c  faros_polito_IMG_show_X.c
	$(CC) $(CFLAGS) $(LDFLAGS) -ljpeg -L/usr/X11R6/lib -lX11 -lXext   -o faros_polito_IMG_receiver faros_polito_IMG_receiver.c errlib.c sockwrap.c faros_polito_IMG_rtp.c faros_polito_IMG_jpg.c faros_polito_IMG_common.c faros_polito_IMG_show_X.c
